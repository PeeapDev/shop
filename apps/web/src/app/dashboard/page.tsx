      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="flex items-center justify-between">
            ...
            <Link href="/dashboard/balance" className="text-blue-600 text-sm hover:underline">
              View
            </Link>
          </div>
        </div>
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="flex items-center justify-between">
            ...
            <Link href="/dashboard/payouts" className="text-blue-600 text-sm hover:underline">
              View
            </Link>
          </div>
        </div>
            ...
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="p-4 flex items-center justify-between hover:bg-gray-50">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Customer {i} - 2 items</p>
                </div>
                <div className="text-right">
                  <p className="font-medium">${(49.99 + i * 20).toFixed(2)}</p>
              ...
              <div key={i} className="p-4 flex items-center justify-between hover:bg-gray-50">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{10 + i * 5} sold</p>
                  </div>
                </div>
        ...
        <div className="border rounded-lg p-4 bg-gray-50">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">shop.peeap.com/store/demo-store</p>
            </div>
          </div>
